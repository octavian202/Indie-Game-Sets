...
namespace Scripts
{
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private readonly float _speedChangeSmoothness = 0.2f;
        private readonly float _inputSmoothness = 0.4f;
        ...
        {
            var _movementInput = new Vector2(Input.GetAxis("Horizontal"), Input.GetAxis("Vertical"));
            velocity = Vector2.Lerp(velocity, _movementInput, _inputSmoothness);
